...
def main():
    ...
    saver1 = manage_checkpoint.Saver(
        ckpt_dir + '/latest', save_type='latest', max_to_keep=10)
    saver2 = manage_checkpoint.Saver(
        ckpt_dir + '/best', save_type='best', max_to_keep=10)
    saver3 = manage_checkpoint.Saver(
        ckpt_dir + '/local_minimum', save_type='local_minimum', interval=10, max_to_keep=10)
